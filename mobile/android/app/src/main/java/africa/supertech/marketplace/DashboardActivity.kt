...
class DashboardActivity : BaseActivity() {
    ...
    private fun loadAdmin() {
        ...
        runOnUiThread {
            ...
            body.addView(linkRow(R.drawable.ic_person, "Profile", "Edit your admin account details") { navigateForward(Intent(this, ManageProfileActivity::class.java)) })
    ...
    private fun loadVendor(session: Net.Session) {
        ...
        runOnUiThread {
            ...
            body.addView(linkRow(R.drawable.ic_person, "Profile", "Edit your vendor account details") { navigateForward(Intent(this, ManageProfileActivity::class.java)) })
