      ...
      <animated.div style={hoverSpring} className="flex h-full flex-col">
        ...
        <div className="relative aspect-[4/4.15] overflow-hidden bg-[var(--background)]">
          ...
          <button
            ...
            className={"absolute right-2 top-2 z-20 flex h-8 w-8 items-center justify-center rounded-full border shadow-sm backdrop-blur-sm transition-all duration-200 " + wishlistButtonClass}
          >
