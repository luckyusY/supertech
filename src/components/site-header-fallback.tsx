      ...
      <div className="hidden border-b border-[var(--line)] bg-white lg:block">
        <div className="page-shell flex h-9 items-center justify-between gap-4 text-xs text-[var(--muted)]">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link href="/track-order" className="transition-colors hover:text-[var(--foreground)]">
              Track Order
            </Link>
            <Link href="/request-product" className="transition-colors hover:text-[var(--foreground)]">
              Request Product
            </Link>
            <Link href="/become-vendor" className="transition-colors hover:text-[var(--foreground)]">
              Become a Vendor
            </Link>
          </div>
        </div>
